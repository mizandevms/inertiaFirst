        ...
        <div class="relative z-10 flex-shrink-0 h-16 bg-white border-b border-gray-200 shadow-sm flex">
            ...
            <div class="flex-1 flex justify-between px-4 sm:px-6">
                ...
                <div class="ml-2 flex items-center space-x-4 sm:ml-6 sm:space-x-6">
                    ...
                    <button type="button" class="flex bg-green-800 p-1 rounded-full items-center justify-center text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
import {CogIcon, CollectionIcon, HomeIcon, MenuAlt2Icon, PhotographIcon, PlusIcon, UserGroupIcon, ViewGridIcon, XIcon} from "@heroicons/vue/outline"
