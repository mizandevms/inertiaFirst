        ...
        <form @submit.prevent="submit()" class="max-w-screen-md mx-auto">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <but    ton type="submit" class="bg-indigo-600 border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Submit</but>
                </div>
            </div>
        </form>
    </app-layout>
